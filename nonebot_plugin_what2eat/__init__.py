...
add_greating = on_command("添加问候", aliases={"添加问候语"}, permission=SUPERUSER | GROUP_ADMIN | GROUP_OWNER, priority=15, block=True)
remove_greating = on_command("删除问候", aliases={"删除问候语"}, permission=SUPERUSER, priority=15, block=True)
